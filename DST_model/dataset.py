...
class Dataset(torch.utils.data.Dataset):
    def __init__(self, args, data_path, data_type):
        ...
        turn_id, dial_id,  question, schema, answer, context= self.seperate_data(raw_dataset)
        ...
        for d_id in dataset.keys():
            ...
            for t_id, turn in enumerate(dialogue):
                ...
                for key_idx, key in enumerate(ontology.QA['all-domain']): 
                    if self.except_domain and self.except_domain in key:continue # TODO check this
    ...
    def __getitem__(self, index):
        ...
        return {"target": target,"turn_id" : turn_id,"question" : question, "context" : context,\
